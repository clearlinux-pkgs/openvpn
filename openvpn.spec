...
Version  : 2.6.1
Release  : 33
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.1/openvpn-2.6.1.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.1/openvpn-2.6.1.tar.gz
...
%prep
%setup -q -n openvpn-2.6.1
cd %{_builddir}/openvpn-2.6.1
pushd ..
cp -a openvpn-2.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678312221
