...
%prep
%setup -q -n openvpn-2.5.8
cd %{_builddir}/openvpn-2.5.8
pushd ..
cp -a openvpn-2.5.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667002484
...
cp %{_builddir}/openvpn-%{version}/COPYING %{buildroot}/usr/share/package-licenses/openvpn/6206f5c60a740675eeccce5d17b0533563b13dcb
pushd ../buildavx2/
%make_install_v3
popd
%make_install
