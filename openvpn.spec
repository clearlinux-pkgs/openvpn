...
Version  : 2.6.7
Release  : 39
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.7/openvpn-2.6.7.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.7/openvpn-2.6.7.tar.gz
...
%prep
%setup -q -n openvpn-2.6.7
cd %{_builddir}/openvpn-2.6.7
pushd ..
cp -a openvpn-2.6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699557425
