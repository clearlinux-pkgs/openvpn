...
Version  : 2.6.10
Release  : 42
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.10/openvpn-2.6.10.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.10/openvpn-2.6.10.tar.gz
...
%prep
%setup -q -n openvpn-2.6.10
cd %{_builddir}/openvpn-2.6.10
pushd ..
cp -a openvpn-2.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710973196
