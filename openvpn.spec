...
Version  : 2.6.12
Release  : 44
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.12/openvpn-2.6.12.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.12/openvpn-2.6.12.tar.gz
...
%prep
%setup -q -n openvpn-2.6.12
cd %{_builddir}/openvpn-2.6.12
pushd ..
cp -a openvpn-2.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721315317
