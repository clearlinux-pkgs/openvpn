...
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.13/openvpn-2.6.13.tar.gz
...
%prep
%setup -q -n openvpn-2.6.13
cd %{_builddir}/openvpn-2.6.13
pushd ..
cp -a openvpn-2.6.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736954816
