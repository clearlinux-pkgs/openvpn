...
Version  : 2.6.11
Release  : 43
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.11/openvpn-2.6.11.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.11/openvpn-2.6.11.tar.gz
...
%prep
%setup -q -n openvpn-2.6.11
cd %{_builddir}/openvpn-2.6.11
pushd ..
cp -a openvpn-2.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718918405
