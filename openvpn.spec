...
Version  : 2.5.2
Release  : 13
URL      : https://github.com/OpenVPN/openvpn/archive/v2.5.2/openvpn-2.5.2.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.5.2/openvpn-2.5.2.tar.gz
...
%prep
%setup -q -n openvpn-2.5.2
cd %{_builddir}/openvpn-2.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619059839
