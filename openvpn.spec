...
Version  : 2.6.14
Release  : 46
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.14/openvpn-2.6.14.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.14/openvpn-2.6.14.tar.gz
...
%prep
%setup -q -n openvpn-2.6.14
cd %{_builddir}/openvpn-2.6.14
pushd ..
cp -a openvpn-2.6.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743614374
