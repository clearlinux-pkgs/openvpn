...
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.5.3/openvpn-2.5.3.tar.gz
...
%prep
%setup -q -n openvpn-2.5.3
cd %{_builddir}/openvpn-2.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624043014
