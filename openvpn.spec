...
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.4.9/openvpn-2.4.9.tar.gz
...
%prep
%setup -q -n openvpn-2.4.9
cd %{_builddir}/openvpn-2.4.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602089827
