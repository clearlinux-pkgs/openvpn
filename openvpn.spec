...
Version  : 2.6.8
Release  : 40
URL      : https://github.com/OpenVPN/openvpn/archive/v2.6.8/openvpn-2.6.8.tar.gz
Source0  : https://github.com/OpenVPN/openvpn/archive/v2.6.8/openvpn-2.6.8.tar.gz
...
%prep
%setup -q -n openvpn-2.6.8
cd %{_builddir}/openvpn-2.6.8
pushd ..
cp -a openvpn-2.6.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703619469
